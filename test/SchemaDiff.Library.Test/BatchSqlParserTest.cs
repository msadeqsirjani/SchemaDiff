...
GO /* blah */";
        ...
        [Fact]
        public void TestLeadingTablesDashDash()
        {
            var scripts = BatchSqlParser.SplitBatch("\t\t\t\t-- comment");
        ...
        {
            var scripts = BatchSqlParser.SplitBatch("\t\t\t\t@param");
        ...
        {
            var scripts = BatchSqlParser.SplitBatch("\t\t\t\t'AddProjectToSourceSafe',");
